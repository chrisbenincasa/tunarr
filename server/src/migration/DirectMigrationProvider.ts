...
import Migration1768000000_AddProgramPlayHistory from './db/Migration1768000000_AddProgramPlayHistory.ts';
      ...
      mapValues(
        {
          ...
          migration1768000000: Migration1768000000_AddProgramPlayHistory,
        },
        wrapWithTransaction,
      ),
    );
