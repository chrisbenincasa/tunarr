...
CREATE TABLE `infinite_schedule` (
	`uuid` text PRIMARY KEY NOT NULL,
	`name` text NOT NULL,
	`pad_to_multiple` integer DEFAULT 0 NOT NULL,
	`flex_preference` text DEFAULT 'end' NOT NULL,
	`time_zone_offset` integer DEFAULT 0 NOT NULL,
	`slot_playback_order` text DEFAULT 'ordered' NOT NULL,
...
--> statement-breakpoint
CREATE UNIQUE INDEX `infinite_schedule_state_channelUuid_unique` ON `infinite_schedule_state` (`channel_uuid`);--> statement-breakpoint
