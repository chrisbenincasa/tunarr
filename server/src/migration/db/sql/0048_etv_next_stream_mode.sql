...
CREATE TABLE `__new_channel` (
	...
	CONSTRAINT "channel_stream_mode_check" CHECK("__new_channel"."stream_mode" in ('hls', 'hls_slower', 'mpegts', 'hls_direct', 'hls_direct_v2', 'etv_next'))
);
--> statement-breakpoint
INSERT INTO `__new_channel`("uuid", "created_at", "updated_at", "disable_filler_overlay", "duration", "filler_repeat_cooldown", "group_title", "guide_flex_title", "guide_minimum_duration", "icon", "name", "number", "offline", "start_time", "stealth", "stream_mode", "transcoding", "transcode_config_id", "watermark", "subtitles_enabled", "stream_selection_profile_id") SELECT "uuid", "created_at", "updated_at", "disable_filler_overlay", "duration", "filler_repeat_cooldown", "group_title", "guide_flex_title", "guide_minimum_duration", "icon", "name", "number", "offline", "start_time", "stealth", "stream_mode", "transcoding", "transcode_config_id", "watermark", "subtitles_enabled", "stream_selection_profile_id" FROM `channel`;--> statement-breakpoint
