...
export interface IOneTimeMigration {
  // Whether the migration should be run in the background.
  // Background migrations can only depend on other background migrations
  // Background migrations also do not prevent the server from starting up.
