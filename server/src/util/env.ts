...
export const SESSION_CLEANUP_DELAY_SECONDS =
  'TUNARR_SESSION_CLEANUP_DELAY_SECONDS';
export const SEARCH_MAX_RAM = 'TUNARR_SEARCH_MAX_MEMORY';
export const SEARCH_REDUCE_INDEXER_MEMORY_USAGE =
...
// "Feature flags"
export const PROXY_ARTWORK_ENV_VAR = 'TUNARR_PROXY_ARTWORK';
...
export const DISABLE_VULKAN = 'TUNARR_DISABLE_VULKAN';
export const DISABLE_VAAPI_PAD = 'TUNARR_DISABLE_VAAPI_PAD';
export const WEBVTT_SIDECAR_ENABLED = 'TUNARR_WEBVTT_SIDECAR_ENABLED';
