...
pnpm drizzle-kit generate # Generates a new database migration using drizzle kit
...
- Database migrations are always generated by executing `pnpm drizzle-kit generate` in the server directory
