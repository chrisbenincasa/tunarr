...
const postApiv2channelsNumberlineup_Body = z.array(
  z.union([
    z.object({
      ...
      title: z.string(),
      sub: z
        .object({ season: z.number(), episode: z.number(), title: z.string() })
        .partial()
        .optional(),
    ...
    z.object({
      ...
      originalProgram: z.union([
        z.object({
          ...
          Director: z.array(z.object({ tag: z.string() })),
          Writer: z.array(z.object({ tag: z.string() })),
          Role: z.array(z.object({ tag: z.string() })),
          directory: z.unknown(),
        }),
        z.object({
          ratingKey: z.string(),
