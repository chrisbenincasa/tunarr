...
export const getApiMediaLibrariesByLibraryIdStatusQueryKey = (options: Options<GetApiMediaLibrariesByLibraryIdStatusData>) => createQueryKey('getApiMediaLibrariesByLibraryIdStatus', options);

export const getApiMediaLibrariesByLibraryIdStatusOptions = (options: Options<GetApiMediaLibrariesByLibraryIdStatusData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getApiMediaLibrariesByLibraryIdStatus({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getApiMediaLibrariesByLibraryIdStatusQueryKey(options)
    });
};
