...
export const bulkAssignFillersQueryKey = (options: Options<BulkAssignFillersData>) => createQueryKey('bulkAssignFillers', options, false, [
    'Channels'
]);

export const bulkAssignFillersOptions = (options: Options<BulkAssignFillersData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await bulkAssignFillers({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: bulkAssignFillersQueryKey(options)
    });
};

export const bulkAssignFillersMutation = (options?: Partial<Options<BulkAssignFillersData>>): UseMutationOptions<BulkAssignFillersResponse, AxiosError<BulkAssignFillersError>, Options<BulkAssignFillersData>> => {
    const mutationOptions: UseMutationOptions<BulkAssignFillersResponse, AxiosError<BulkAssignFillersError>, Options<BulkAssignFillersData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await bulkAssignFillers({
                ...options,
                ...localOptions,
