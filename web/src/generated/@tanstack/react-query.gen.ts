...
export const postApiChannelsByIdProgrammingMutation = (options?: Partial<Options<PostApiChannelsByIdProgrammingData>>): UseMutationOptions<PostApiChannelsByIdProgrammingResponse, AxiosError<PostApiChannelsByIdProgrammingError>, Options<PostApiChannelsByIdProgrammingData>> => {
    const mutationOptions: UseMutationOptions<PostApiChannelsByIdProgrammingResponse, AxiosError<PostApiChannelsByIdProgrammingError>, Options<PostApiChannelsByIdProgrammingData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await postApiChannelsByIdProgramming({
                ...options,
                ...localOptions,
...
export const putApiCustomShowsByIdMutation = (options?: Partial<Options<PutApiCustomShowsByIdData>>): UseMutationOptions<PutApiCustomShowsByIdResponse, AxiosError<PutApiCustomShowsByIdError>, Options<PutApiCustomShowsByIdData>> => {
    const mutationOptions: UseMutationOptions<PutApiCustomShowsByIdResponse, AxiosError<PutApiCustomShowsByIdError>, Options<PutApiCustomShowsByIdData>> = {
        mutationFn: async (localOptions) => {
...
export const postApiFfmpegSettingsMutation = (options?: Partial<Options<PostApiFfmpegSettingsData>>): UseMutationOptions<PostApiFfmpegSettingsResponse, AxiosError<PostApiFfmpegSettingsError>, Options<PostApiFfmpegSettingsData>> => {
    const mutationOptions: UseMutationOptions<PostApiFfmpegSettingsResponse, AxiosError<PostApiFfmpegSettingsError>, Options<PostApiFfmpegSettingsData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await postApiFfmpegSettings({
                ...options,
                ...localOptions,
...
export const jellyfinLoginMutation = (options?: Partial<Options<JellyfinLoginData>>): UseMutationOptions<JellyfinLoginResponse, AxiosError<JellyfinLoginError>, Options<JellyfinLoginData>> => {
    const mutationOptions: UseMutationOptions<JellyfinLoginResponse, AxiosError<JellyfinLoginError>, Options<JellyfinLoginData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await jellyfinLogin({
                ...options,
                ...localOptions,
...
export const postApiEmbyLoginMutation = (options?: Partial<Options<PostApiEmbyLoginData>>): UseMutationOptions<PostApiEmbyLoginResponse, AxiosError<PostApiEmbyLoginError>, Options<PostApiEmbyLoginData>> => {
    const mutationOptions: UseMutationOptions<PostApiEmbyLoginResponse, AxiosError<PostApiEmbyLoginError>, Options<PostApiEmbyLoginData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await postApiEmbyLogin({
                ...options,
                ...localOptions,
...
export const deleteApiTrashMutation = (options?: Partial<Options<DeleteApiTrashData>>): UseMutationOptions<DeleteApiTrashResponse, AxiosError<DefaultError>, Options<DeleteApiTrashData>> => {
    const mutationOptions: UseMutationOptions<DeleteApiTrashResponse, AxiosError<DefaultError>, Options<DeleteApiTrashData>> = {
        mutationFn: async (localOptions) => {
...
export const getApiTrashQueryKey = (options?: Options<GetApiTrashData>) => createQueryKey('getApiTrash', options, false, [
    'Trash'
]);
...
export const getApiTrashStatusQueryKey = (options?: Options<GetApiTrashStatusData>) => createQueryKey('getApiTrashStatus', options, false, [
    'Trash'
]);

export const getApiTrashStatusOptions = (options?: Options<GetApiTrashStatusData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getApiTrashStatus({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getApiTrashStatusQueryKey(options)
    });
};

export const postApiTrashCancelQueryKey = (options?: Options<PostApiTrashCancelData>) => createQueryKey('postApiTrashCancel', options, false, [
    'Trash'
]);

export const postApiTrashCancelOptions = (options?: Options<PostApiTrashCancelData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await postApiTrashCancel({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: postApiTrashCancelQueryKey(options)
    });
};

export const postApiTrashCancelMutation = (options?: Partial<Options<PostApiTrashCancelData>>): UseMutationOptions<PostApiTrashCancelResponse, AxiosError<DefaultError>, Options<PostApiTrashCancelData>> => {
    const mutationOptions: UseMutationOptions<PostApiTrashCancelResponse, AxiosError<DefaultError>, Options<PostApiTrashCancelData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await postApiTrashCancel({
                ...options,
                ...localOptions,
