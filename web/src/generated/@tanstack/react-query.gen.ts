...
export const postApiMoviesByIdScanMutation = (options?: Partial<Options<PostApiMoviesByIdScanData>>): UseMutationOptions<unknown, AxiosError<DefaultError>, Options<PostApiMoviesByIdScanData>> => {
    const mutationOptions: UseMutationOptions<unknown, AxiosError<DefaultError>, Options<PostApiMoviesByIdScanData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await postApiMoviesByIdScan({
                ...options,
                ...localOptions,
...
export const postApiShowsByIdScanMutation = (options?: Partial<Options<PostApiShowsByIdScanData>>): UseMutationOptions<unknown, AxiosError<DefaultError>, Options<PostApiShowsByIdScanData>> => {
    const mutationOptions: UseMutationOptions<unknown, AxiosError<DefaultError>, Options<PostApiShowsByIdScanData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await postApiShowsByIdScan({
                ...options,
                ...localOptions,
