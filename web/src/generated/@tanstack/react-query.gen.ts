...
export const getApiEtvPlayoutItemQueryKey = (options?: Options<GetApiEtvPlayoutItemData>) => createQueryKey('getApiEtvPlayoutItem', options, false, [
    'Streaming'
]);
 ...
 */
export const getApiEtvPlayoutItemOptions = (options?: Options<GetApiEtvPlayoutItemData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getApiEtvPlayoutItem({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getApiEtvPlayoutItemQueryKey(options)
    });
};

export const getApiEtvTranscodeConfigsByIdCompatibilityQueryKey = (options: Options<GetApiEtvTranscodeConfigsByIdCompatibilityData>) => createQueryKey('getApiEtvTranscodeConfigsByIdCompatibility', options, false, [
    'Streaming',
    'Transcode Configs'
]);
 ...
 */
export const getApiEtvTranscodeConfigsByIdCompatibilityOptions = (options: Options<GetApiEtvTranscodeConfigsByIdCompatibilityData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getApiEtvTranscodeConfigsByIdCompatibility({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getApiEtvTranscodeConfigsByIdCompatibilityQueryKey(options)
    });
};
