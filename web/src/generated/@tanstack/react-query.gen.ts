...
export const getApiDebugLogQueryKey = (options?: Options<GetApiDebugLogData>) => createQueryKey('getApiDebugLog', options);

export const getApiDebugLogOptions = (options?: Options<GetApiDebugLogData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getApiDebugLog({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getApiDebugLogQueryKey(options)
    });
};
