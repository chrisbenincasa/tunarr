...
export const postApiSchedulesMutation = (options?: Partial<Options<PostApiSchedulesData>>): UseMutationOptions<PostApiSchedulesResponse, AxiosError<DefaultError>, Options<PostApiSchedulesData>> => {
    const mutationOptions: UseMutationOptions<PostApiSchedulesResponse, AxiosError<DefaultError>, Options<PostApiSchedulesData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await postApiSchedules({
                ...options,
                ...localOptions,
...
export const updateScheduleByIdMutation = (options?: Partial<Options<UpdateScheduleByIdData>>): UseMutationOptions<UpdateScheduleByIdResponse, AxiosError<DefaultError>, Options<UpdateScheduleByIdData>> => {
    const mutationOptions: UseMutationOptions<UpdateScheduleByIdResponse, AxiosError<DefaultError>, Options<UpdateScheduleByIdData>> = {
        mutationFn: async (localOptions) => {
