...
export const SearchFilterOperatorNodeSchema: z.ZodType<SearchFilterOperatorNode> =
  z.lazy(() =>
    z.object({
      type: z.literal('op'),
      op: z.union([z.literal('or'), z.literal('and')]),
      children: SearchFilterQuerySchema.array(),
    }),
  );

export const SearchFilterQuerySchema = SearchFilterOperatorNodeSchema.or(
  SearchFilterValueNodeSchema,
);

export type SearchFilter = SearchFilterOperatorNode | SearchFilterValueNode;
